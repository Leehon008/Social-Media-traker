...
def main():
    api = TwitterClient()
    tweets = api.get_tweets(query = ['Zimbabwe WildLife', 'Zimbabwe Tourism Authority', 'Zimbabwe Parks',
                    'Zimbabwe Tourism', 'Zimbabwe Parks and Wildlife', 'Zimbabwe BeautifulZim'], count = 200)
